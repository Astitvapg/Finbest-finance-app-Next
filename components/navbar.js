      ...
      <nav className="navbar-navbar">
        <div className="navbar-desktop">
          ...
          <div className="navbar-quick-actions">
            <Link href="/">
              <a className="link navbar-link09">Log in</a>
            </Link>
            <Link href="/">
        ...
        <div id="mobile-menu" className="navbar-mobile">
          ...
          <div className="navbar-links1">
            <Link href="/">
              <a className="navbar-link11">{props.text1}</a>
            </Link>
            <Link href="/">
              <a className="navbar-link12">{props.text11}</a>
            </Link>
            <Link href="/">
              <a className="navbar-link13">{props.text12}</a>
            </Link>
            <Link href="/">
              <a className="navbar-link14">{props.text13}</a>
            </Link>
