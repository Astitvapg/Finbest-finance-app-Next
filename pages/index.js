          ...
          <div className="home-hero">
            <div className="home-content">
              ...
              <span className="home-caption">
                We at Finbest One Of the Grrowing No-Profit Startup Try To
                Deliver The Best We Have With Us.............................
              </span>
            ...
            <div className="home-images">
              ...
              <div className="home-column1">
                <img
                  alt="pastedImage"
                  src="/playground_assets/pastedimage-v31-1500h.png"
          ...
          <div className="home-content01">
            ...
            <div className="home-video-container">
              <video
                ...
                loop
                muted
                poster="/playground_assets/pastedimage-v2-900w.png"
                autoPlay
        ...
        <div className="home-stats">
          <div className="home-stat">
            ...
            <span className="home-description">
              Our Efficiiency Is To Manage This amout of Customer at a time
            </span>
          </div>
            ...
            <div className="home-hero-buttons1">
              <div className="home-io-btn1">
                <Image
                  ...
                  height={20}
                />
                <span className="home-caption5">Download for iOS</span>
              </div>
              <div className="home-android-btn1">
                <Image
                  ...
                  height={20}
                />
                <span className="home-caption6">Download for Android</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <style jsx>
        {`
          ...
          .home-image-overlay {
            ...
            background-size: cover;
            justify-content: center;
            background-image: url('/playground_assets/pastedimage-v31-1500h.png');
          }
          .home-content05 {
            gap: var(--dl-space-space-oneandhalfunits);
            display: flex;
          ...
          .home-overlay {
            ...
            background-size: cover;
            justify-content: center;
            background-image: url('/playground_assets/mask%20group.svg');
          }
          .home-text14 {
            color: rgb(193, 255, 252);
            width: 100%;
